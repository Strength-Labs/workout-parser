...
from src.settings import create_workspace, switch_workspace, list_workspaces, get_workspace_settings
from src.api_client import get_access_token, sanitize_workspace_name
...
def setup_new_workspace():
    ...
    try:
        ...
        from src.settings import create_workspace as temp_create
        temp_create('temp-test', 'Temp', email, password)
        from src.settings import switch_workspace
    ...
    try:
        ...
        if 'temp-test' in settings.get('workspaces', {}):
            ...
            from src.settings import save_workspace_settings
