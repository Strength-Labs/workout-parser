...
from src.api_client import get_user_profile, sanitize_workspace_name
from src.directory_migration import get_workspace_base_dir, migrate_to_workspace_directory
...
def setup_new_workspace():
    ...
    try:
        ...
        from src.api_client import get_access_token, get_user_profile
...
def auto_migrate_for_existing_users():
    ...
    from src.directory_migration import needs_workspace_migration, migrate_to_workspace_directory
...
def ensure_workspace_directories():
    ...
    try:
        from src.directory_migration import get_new_paths
        paths = get_new_paths()
...
def logout_current_workspace():
    ...
    try:
        from src.api_client import get_token_cache_file
